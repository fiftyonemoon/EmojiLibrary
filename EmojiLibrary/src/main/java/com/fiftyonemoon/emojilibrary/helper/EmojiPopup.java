...
import com.fiftyonemoon.emojilibrary.category.Cars;
import com.fiftyonemoon.emojilibrary.category.Electr;
import com.fiftyonemoon.emojilibrary.category.Emoji;
import com.fiftyonemoon.emojilibrary.category.Flags;
import com.fiftyonemoon.emojilibrary.category.Food;
import com.fiftyonemoon.emojilibrary.category.Nature;
import com.fiftyonemoon.emojilibrary.category.People;
import com.fiftyonemoon.emojilibrary.category.Sport;
import com.fiftyonemoon.emojilibrary.category.Symbols;
import java.util.Arrays;
import java.util.List;


public class EmojiPopup extends PopupWindow implements ViewPager.OnPageChangeListener, EmojiRecentInterface {
    ...
    int backPressed = Color.parseColor("#DCE1E2");
    ...
    private View createCustomView() {
        ...
        EmojiRecentInterface recents = this;
        mEmojisAdapter = new EmojisPagerAdapter(Arrays.asList(new EmojiRecentsGridView(mContext, null, null, this, mUseSystemDefault),
                ...
                new EmojiGridView(mContext, Flags.DATA, recents, this, mUseSystemDefault)
        ...
        mEmojiTabs[8] = view.findViewById(R.id.emojis_tab_8_flg);
        ...
        imgBtn.setBackgroundColor(backPressed);
